...
| `PYTORCH_ALLOC_CONF` | For a more in depth explanation of this environment variable, see [Memory management](https://docs.pytorch.org/docs/2.13/notes/cuda.html#cuda-memory-management). `PYTORCH_CUDA_ALLOC_CONF` is its alias and is provided only for backward compatibility. |
