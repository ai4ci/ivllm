...
| `TORCH_NCCL_DUMP_ON_TIMEOUT` | Control whether dumping debug info on watchdog timeout or exception is detected. This variable must be set together with TORCH\_NCCL\_TRACE\_BUFFER\_SIZE larger than 0. |
